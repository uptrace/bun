...
require (
	...
	github.com/uptrace/bun/dbfixture v0.4.1
	github.com/uptrace/bun/dialect/mysqldialect v0.4.1
	github.com/uptrace/bun/dialect/pgdialect v0.4.1
	github.com/uptrace/bun/dialect/sqlitedialect v0.4.1
	github.com/uptrace/bun/driver/pgdriver v0.4.1
