...
require (
	...
	github.com/uptrace/bun/dbfixture v1.0.10
	github.com/uptrace/bun/dialect/mysqldialect v1.0.10
	github.com/uptrace/bun/dialect/pgdialect v1.0.10
	github.com/uptrace/bun/dialect/sqlitedialect v1.0.10
	github.com/uptrace/bun/driver/pgdriver v1.0.10
