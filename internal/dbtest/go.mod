...
require (
	...
	github.com/uptrace/bun/dbfixture v1.0.1
	github.com/uptrace/bun/dialect/mysqldialect v1.0.1
	github.com/uptrace/bun/dialect/pgdialect v1.0.1
	github.com/uptrace/bun/dialect/sqlitedialect v1.0.1
	github.com/uptrace/bun/driver/pgdriver v1.0.1
	github.com/uptrace/bun/driver/sqliteshim v1.0.1
	github.com/uptrace/bun/extra/bundebug v1.0.1
)
